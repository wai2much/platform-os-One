 ...
 */
const STATUS = {
  Regular: { color: 'var(--positive)', bg: 'rgba(31,109,61,.16)' },
  Overdue: { color: '#fff', bg: 'var(--vermillion)' },
  'Credit hold': { color: '#fff', bg: '#201c16' },
    ...
    <div style={{ padding: '6px 30px 26px' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 16 }}>
        ...
        <input value={q} onChange={(e) => setQ(e.target.value)} placeholder="Search name, phone, vehicle…"
          style={{ background: 'var(--panel-bg)', border: 'none', borderRadius: 999, padding: '8px 14px', fontSize: 12.5, fontFamily: 'Zen Kaku Gothic New, sans-serif', color: 'var(--text)', outline: 'none', width: 220 }} />
        <span style={{ flex: 1 }} />
        <span onClick={() => setCreating(true)} className="fg" style={{ fontSize: 12, fontWeight: 700, background: 'var(--vermillion)', color: '#fff', borderRadius: 999, padding: '8px 18px', cursor: 'pointer' }}>+ New customer</span>
      </div>
